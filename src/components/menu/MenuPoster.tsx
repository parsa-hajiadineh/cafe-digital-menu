...
export function MenuPoster({ item }: MenuPosterProps) {
  return (
    <article className="sheen motion-rise-soft relative overflow-hidden rounded-[1.75rem] border border-sage/40 bg-[linear-gradient(155deg,#bac7bc_0%,#f4f6f4_52%,#e4eae5_100%)] px-5 py-6 shadow-[0_22px_48px_rgba(42,51,46,0.08)]">
      ...
      <div className="relative">
        ...
        <div className="mt-5 flex items-end justify-between gap-3">
          ...
          <p className="text-sm tracking-wide text-sage-deep">
