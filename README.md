...
src/
  ...
  components/brand/    # نشان‌های گرافیکی و گیاهی
  components/layout/   # شِل، هدر، فوتر و فضای پس‌زمینه
  components/menu/     # نمای منو (هیرو، پوستر، دسته‌ها و کارت آیتم)
...
- مرحله ۳: جزئیات بصری آیتم و ریتم لوکس‌تر صفحه — انجام شده
- مرحله ۴: انیمیشن‌های مینیمال — انجام شده
- مرحله ۵: پولیش نهایی موبایل — انجام شده
